...
- new accounts start on the Free plan automatically (no plan selection step); after upload `record` prints an upgrade link for higher render and active-video limits and expressive narration
