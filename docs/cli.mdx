...
language**, **Add to repository**, and **Add to CI** buttons in the app
produce a prompt that carries a one-time setup code and points the agent at
the brief for that button (`screenci.com/add-project.md`, `/add-video.md`,
