    ...
    "Onboarding": {
      ...
      "languages": {
        "en": {
          ...
          "latestRecord": {
            "status": "finished",
            "video": "https://api.screenci.com/public/kh74…/en/video?record=5f1c…",
            "thumbnail": "https://api.screenci.com/public/kh74…/en/thumbnail?record=5f1c…",
            "subtitle": "https://api.screenci.com/public/kh74…/en/subtitle?record=5f1c…",
            "download": {
...
- `latestRecord`: this run's render status plus public URLs pinned to it with
  `?record=<recordId>` (an immutable contract: the exact run, or `404`, see
