...
- `videos/*.screenci.ts` still compile without deprecated imports
...
- make sure generated scripts still target `screenci/videos/*.screenci.ts` and use the current ScreenCI helpers
