...
export type Registration = {
   ...
   * + the `each` variant patch, pre-merged), or an editable marker when the bag
   * is web-owned, or `null` for none.
   */
  recordOptions:
   ...
   * pre-merged), or an editable marker when web-owned, or `null` for none.
   */
  renderOptions:
...
> {
   ...
   * shared across languages, a language-major object (`{ default, de, ... }`)
   * with per-language overrides, or `editable()` to hand the bag to the web app.
   */
   ...
   * object shared across languages, a language-major object with per-language
   * overrides, or `editable()` to hand the bag to the web app.
   */
